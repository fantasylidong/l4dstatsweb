...
$arr_kills = array();
$arr_kills['普通感染者:'] = $total['kill_infected'];
...
$arr_survivor_awards['赠与药丸总数:'] = $total['award_pills'];
$arr_survivor_awards['赠与肾上腺素总数:'] = $total['award_adrenaline'];
$arr_survivor_awards['赠与医疗包总数:'] = $total['award_medkit'];
$arr_survivor_awards['将队友从Hunter手里救下总数:'] = $total['award_hunter'];
$arr_survivor_awards['将队友从Smokers手里救下总数:'] = $total['award_smoker'];
$arr_survivor_awards['将队友从Jockeys手里救下总数:'] = $total['award_jockey'];
$arr_survivor_awards['将队友从Chargers手里救下总数:'] = $total['award_charger'];
$arr_survivor_awards['近战秒牛总数:'] = $total['award_matador'];
$arr_survivor_awards['倒油总数:'] = $total['award_gascans_poured'];
$arr_survivor_awards['弹药包部署总数:'] = $total['award_upgrades_added'];
$arr_survivor_awards['秒妹总数:'] = $total['award_witchcrowned'];
$arr_survivor_awards['保护队友总次数:'] = $total['award_protect'];
$arr_survivor_awards['拉起队友总次数:'] = $total['award_revive'];
$arr_survivor_awards['营救队友总次数:'] = $total['award_rescue'];
$arr_survivor_awards['团队摧毁Tank总数:'] = $total['award_tankkill'];
$arr_survivor_awards['团队无人死亡摧毁Tank总数:'] = $total['award_tankkillnodeaths'];
$arr_survivor_awards['所有幸存者都活着到达安全门总数:'] = $total['award_allinsafehouse'];
$arr_survivor_awards['地图完成总数:'] = $total['award_campaigns'];
$arr_infected_awards = array();
$arr_infected_awards['造成幸存者全部死亡总次数:'] = $total['award_infected_win'];
$arr_infected_awards['完美致盲总次数:'] = $total['award_perfect_blindness'];
$arr_infected_awards['完美高扑总次数:'] = $total['award_pounce_perfect'];
$arr_infected_awards['较好扑总次数:'] = $total['award_pounce_nice'];
$arr_infected_awards['坦克造成大量伤害次数:'] = $total['award_bulldozer'];
$arr_infected_awards['幸存者被制服总次数:'] = $total['award_survivor_down'];
$arr_infected_awards['造成幸存者挂边总次数:'] = $total['award_ledgegrab'];
if ($game_version != 1) { $arr_infected_awards['牛撞到全部人总次数:'] = $total['award_scatteringram']; }
$arr_demerits = array();
$arr_demerits['黑枪总次数:'] = $total['award_friendlyfire'];
$arr_demerits['黑倒队友总次数:'] = $total['award_fincap'];
$arr_demerits['击杀队友总次数:'] = $total['award_teamkill'];
$arr_demerits['丢下队友总次数:'] = $total['award_left4dead'];
$arr_demerits['让感染者进安全门总次数:'] = $total['award_letinsafehouse'];
$arr_demerits['惊扰witch次数:'] = $total['award_witchdisturb'];
...
while ($row = mysql_fetch_array($result)) {
	...
	$arr_vals = array();
	switch ($row['gamemode']) {
		case 0: $gamemodename = "战役"; break;
		case 1: $gamemodename = "对抗"; break;
		case 2: if ($game_version == 1) continue 2; $gamemodename = "写实"; break;
		case 3: $gamemodename = "生存"; break;
		case 4: if ($game_version == 1) continue 2; $gamemodename = "清道夫"; break;
		case 5: if ($game_version == 1) continue 2; $gamemodename = "写实对抗"; break;
		case 6: if ($game_version == 1) continue 2; $gamemodename = "突变模式"; break;
	}
