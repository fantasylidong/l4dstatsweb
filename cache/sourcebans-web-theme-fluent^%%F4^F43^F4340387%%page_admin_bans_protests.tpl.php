...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'page_admin_bans_protests.tpl', 173, false),)), $this); ?>
...
<?php else: ?>
    <div class="admin_tab_content_title">
        <h2>Ban Protests (<span id="protcount"><?php echo $this->_tpl_vars['protest_count']; ?>
</span>)</h2>
    </div>
    ...
    <div class="padding">
        ...
        <div class="pagination">
            <span><?php echo $this->_tpl_vars['protest_nav']; ?>
</span>
        </div>
