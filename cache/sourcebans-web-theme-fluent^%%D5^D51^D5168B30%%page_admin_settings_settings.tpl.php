...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'page_admin_settings_settings.tpl', 244, false),)), $this); ?>
    ...
    <div class="padding">
        ...
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=1 class="form-input form-full" id="template_title" name="template_title"
                value="<?php echo $this->_tpl_vars['config_title']; ?>
" />
        ...
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=2 class="form-input form-full" id="template_logo" name="template_logo"
                value="<?php echo $this->_tpl_vars['config_logo']; ?>
" />
        ...
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=3 class="form-input form-full" id="config_password_minlength"
                name="config_password_minlength" value="<?php echo $this->_tpl_vars['config_min_password']; ?>
" />
        ...
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=4 class="form-input form-full" id="config_dateformat" name="config_dateformat"
                value="<?php echo $this->_tpl_vars['config_dateformat']; ?>
" />
        ...
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=4 class="form-input form-full" id="auth_maxlife" name="auth_maxlife"
                value="<?php echo $this->_tpl_vars['auth_maxlife']; ?>
" />
        ...
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=4 class="form-input form-full" id="auth_maxlife_remember"
                name="auth_maxlife_remember" value="<?php echo $this->_tpl_vars['auth_maxlife_remember']; ?>
" />
        ...
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=4 class="form-input form-full" id="auth_maxlife_steam" name="auth_maxlife_steam"
                value="<?php echo $this->_tpl_vars['auth_maxlife_steam']; ?>
" />
    ...
    <div class="padding">
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=7 class="form-input form-full" id="dash_intro_title" name="dash_intro_title"
                value="<?php echo $this->_tpl_vars['config_dash_title']; ?>
" />
        ...
        <div class="margin-bottom:half">
            ...
            <textarea TABINDEX=6 cols="80" rows="20" class="form-text" id="dash_intro_text"
                name="dash_intro_text"><?php echo $this->_tpl_vars['config_dash_text']; ?>
</textarea>
    ...
    <div class="padding">
        ...
        <div class="margin-bottom:half">
            ...
            <?php echo smarty_function_sb_button(array('text' => 'Clear Cache','onclick' => "xajax_ClearCache();",'class' => "button button-light",'id' => 'clearcache','submit' => false), $this);?>
    ...
    <div class="padding">
        <div class="margin-bottom:half">
            ...
            <input type="text" TABINDEX=12 class="form-input form-full" id="banlist_bansperpage"
                name="banlist_bansperpage" value="<?php echo $this->_tpl_vars['config_bans_per_page']; ?>
" />
...
?>
                    <tr>
                        <td><input type="text" class="textbox" name="bans_customreason[]" id="bans_customreason[]"
                                value="<?php echo $this->_tpl_vars['creason']; ?>
" /></td>
                    </tr>
    ...
    <div class="padding flex flex-ai:center flex-jc:space-between">
        <?php echo smarty_function_sb_button(array('text' => 'Save Changes','class' => "button button-success",'id' => 'asettings','submit' => true), $this);?>

        <?php echo smarty_function_sb_button(array('text' => 'Back','class' => "button button-light",'id' => 'aback'), $this);?>
