...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'page_admin_bans_submissions_archiv.tpl', 60, false),array('modifier', 'escape', 'page_admin_bans_submissions_archiv.tpl', 203, false),)), $this); ?>
...
<?php else: ?>
    <div class="admin_tab_content_title">
        <h2>Ban Submissions Archive (<span id="subcountarchiv"><?php echo $this->_tpl_vars['submission_count_archiv']; ?>
</span>)</h2>
    </div>
    ...
    <div class="padding">
        ...
        <div class="pagination">
            <span><?php echo $this->_tpl_vars['asubmission_nav']; ?>
</span>
        </div>
                                    ...
                                    <div class="padding flex flex-jc:start">
                                        ...
                                        <ul class="ban_list_detal">
                                            <li>
                                                ...
                                                <span>
                                                    <?php echo $this->_tpl_vars['sub']['archive']; ?>
                                            ...
                                            <li>
                                                ...
                                                <div id="suba<?php echo $this->_tpl_vars['sub']['subid']; ?>
">
                                            ...
                                            <li>
                                                ...
                                                <?php else: ?>
                                                    <span><?php echo $this->_tpl_vars['sub']['archivedby']; ?>
</span>
                                                <?php endif; ?>
                                            </li>
                                        </ul>
