		...
		<div class="col-md-4 col-lg-4 text-center text-md-right">
			<form method="post" action="search.php">
				<div class="input-group">
					<input type="search" placeholder="玩家姓名或者SteamID" aria-describedby="button-addon5" class="form-control rounded-0 w-50 search" name="search">&nbsp;&nbsp;&nbsp;
	...
	<div class="text-right text-md-right">
		<div class="row d-flex align-items-right">
			<div class="col-md-2 col-lg-2 text-center text-md-left my-auto">
				<small>页面: <?php echo $page_now;?> / <?php echo $page_max;?></small>
			</div>
