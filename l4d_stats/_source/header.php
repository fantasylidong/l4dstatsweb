		...
		<div id="mySidebar" class="sidebar">
			...
			<div class="container mobile_submenu">
				...
				<div class="dropdown-container">
					<a href="<?php echo $site_statsurl;?>ranking/index.php"><i class="fa fa-angle-right"></i> 全部</a>
				...
				<div class="dropdown-container">
					<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=anne"><i class="fa fa-angle-right"></i> AnneHappy药役</a>
					<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=witchparty"><i class="fa fa-angle-right"></i> 女巫派对</a>
					<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=allcharger"><i class="fa fa-angle-right"></i> 牛牛冲刺</a>
					<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=alone"><i class="fa fa-angle-right"></i> 单人装逼</a>
					<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=hunters"><i class="fa fa-angle-right"></i> 1vht</a>
				</div>
				...
				<a href="<?php echo $site_statsurl;?>awards/index.php"><i class="fa fa-trophy"></i> 奖项</a>
				<?php if ($gameserver == "enabled"): ?><a href="<?php echo $site_statsurl;?>gameserver/index.php"><i class="fa fa-server"></i> 服务器状态</a><?php endif; ?>
				<a href="<?php echo $site_statsurl;?>statistics/index.php"><i class="fa fa-bar-chart"></i> 数据</a>
						...
						<div class="navbar-v2">
							<div class="dropdown-v2">
								...
								<div class="dropdown-content-v2">
									<a href="<?php echo $site_statsurl;?>ranking/index.php">全部排名</a>
							...
							<div class="dropdown-v2">
								<button class="dropbtn-v2"><i class="fa fa-road"></i> 地图完成时间
									<i class="fa fa-caret-down"></i>
								</button>
								<div class="dropdown-content-v2">
									<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=anne"> AnneHappy药役</a>
									<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=witchparty"> 女巫派对</a>
									<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=allcharger"> 牛牛冲刺</a>
									<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=alone"> 单人装逼</a>
									<a href="<?php echo $site_statsurl;?>mapranking/index.php?type=hunters"> 1vht</a>
								</div>
							</div>
							<div class="dropdown-v2">
								...
								<div class="dropdown-content-v2">
									<a href="<?php echo $site_statsurl;?>campaigns/index.php?type=coop">战役</a>
